            ...
            <section className="h-100" style={{backgroundColor: "#eee"}}>
                <div className="container h-100 py-5">
                    ...
                    <div className="col-10">
                        ...
                        {check ? <div className="d-flex justify-content-center align-items-center" style={{height:"100vh"}}><h1>Loading...</h1></div> :
                        items && items.length==0 ? 
                        <div className="d-flex justify-content-center"><h4 style={{fontStyle:"italic"}}>Nothing in cart</h4></div>:
                            items.map((val,index)=>{
                            return(
